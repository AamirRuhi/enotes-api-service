...
public class Validation {
	...
	public void userValidation(UserRequest userDto) {
		...
		if (!StringUtils.hasText(userDto.getEmail()) || !userDto.getEmail().matches(Constants.EMAIL_REGEX)) {
			// regex ke help se email ko validate krenge like @ symble h ,gmail h. in util
			// pakege me Constant class bnalenge usme ,matches method h
		...
		if (!StringUtils.hasText(userDto.getMobNo()) || !userDto.getMobNo().matches(Constants.MOBNO_REGEX)) {
			// regex ke help se mobno ko validate krenge like . in util pakege me Constant
			// class bnalenge usme ,matches method h
